...
describe("[Challenge] Climber", function () {
  ...
  it("Execution", async function () {
    ...
    let testClimber = await (
      await ethers.getContractFactory("testClimber", player)
    ).deploy(token.address, timelock.address, vault.address, player.address);
    await testClimber.start();
  });
